...
function getSeed(bytes32 _bankAccountNumberORContractID) public constant returns(bytes32 seed){
  ...
  require(msg.sender == owner || UserID[msg.sender]==Seeds[_bankAccountNumberORContractID].lenderID || UserID[msg.sender]==Seeds[_bankAccountNumberORContractID].companyID || UserID[msg.sender]==Seeds[_bankAccountNumberORContractID].collectionAgencyID );
 ...
 */
    function retriveTransactionC2CIPFS(uint256 _index) public constant returns(bytes32 lenderID,string Hash,bytes32 contractID){
      ...
      require(CompanyDetails[_companyID].companyAccountAddress==msg.sender || owner==msg.sender );
        ...
        return(IPFSTransactionDetailsC2C[_companyID][_index].company2ID,IPFSTransactionDetailsC2C[_companyID][_index].Hash,IPFSTransactionDetailsC2C[_companyID][_index].contractID);
    }
 ...
 * @return : tx details
 */
    function retriveCollectionAgencyTxOnDelay(uint256 _index) public constant returns(bytes32 CollectionAgencyID,string Hash,bytes32){
      bytes32 _companyID = UserID[msg.sender];

      require(CompanyDetails[_companyID].companyAccountAddress==msg.sender || owner==msg.sender );
        return(IPFSCollectionAgencyTxOnDelay[_companyID][_index].collectionAgencyID,IPFSCollectionAgencyTxOnDelay[_companyID][_index].Hash,IPFSCollectionAgencyTxOnDelay[_companyID][_index].contractID);
    }
}